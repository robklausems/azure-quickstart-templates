...
echo "/sbin/blockdev --setra 16384 /dev/sdd" >> /etc/rc.d/rc.local
echo "/sbin/blockdev --setra 16384 /dev/sde" >> /etc/rc.d/rc.local
echo "/sbin/blockdev --setra 16384 /dev/sdf" >> /etc/rc.d/rc.local
echo "/sbin/blockdev --setra 16384 /dev/sdg" >> /etc/rc.d/rc.local
...
blkid -u filesystem /dev/md127 > ~/blkinfo.txt
